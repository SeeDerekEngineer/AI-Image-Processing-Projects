...
public class CTScanImage {
	   ...
	   private int[][] rawValue = new int[xEnd-xStart][yEnd-yStart];
	   ...
	   File f = null;
	   BufferedImage img = new BufferedImage(xEnd-xStart, yEnd-yStart, BufferedImage.TYPE_INT_RGB);   //Determines size of produced image
	   BufferedImage img2 = new BufferedImage(xEnd-xStart, yEnd-yStart, BufferedImage.TYPE_INT_RGB);  //Determines size of produced image
	   BufferedImage img3 = new BufferedImage(xEnd-xStart, yEnd-yStart, BufferedImage.TYPE_INT_RGB);  //Determines size of produced image
